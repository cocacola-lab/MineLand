...
def main():
    ...
    alex_Bob = Alex(save_path=save_path+'/Bob', personality="Openness")
    alex_Alice = Alex(save_path=save_path+'/Alice', personality="Openness")
    iteration = 0
    ...
    for i in range (5000):
        ...
        task_info.guidance = '\nThere are two agent in total. The names of agents are Alice and Bob, one of them is you! The other agent is your friend, you should cooperate with him.'
        # obs[0].rgb_base64 = ''
