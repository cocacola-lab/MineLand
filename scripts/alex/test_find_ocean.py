...
task_id = "explore_the_world_to_find_ocean"
...
def main():
    ...
    alex = Alex(save_path=save_path, personality="I am a explorer, I only want to go and explore, I don't need any resources!")
