...
class TechtreeTask(BaseTask):
    def __init__(
        ...
        **kwargs,
        ...
        self.mode = mode
        # print(type(initial_inventory))
        # print(initial_inventory)
        print(f'{self.agents_count} Agent(s) need to get {self.num_of_target_item} x {self.target_item}')
        # print(goal)
    def reset(self):
        obs = self.env.reset()
    ...
    def step(self, action):
        ...
        task_info = TaskInfo(
            ...
            is_failed=False,
            goal=self.goal + '\n',
                #  + f'Agent(s) have gotten {has_gotten}, {self.num_of_target_item - has_gotten} more to go.',
